            ...
            <div class="container pt-3">
                <div class="row justify-content-between align-items-center py-5 mb-3">
                    <div class="col-auto mb-4 mb-lg-0">
                        <h2 class="font-weight-semibold text-color-light text-10 ls-0 mb-0">Ethio Omny Trading Plc</h2>
                    </div>
                    <div class="col-auto">
                ...
                <div class="row pt-3 mt-5">
                    <div class="col-lg-3 mb-4 mb-lg-0">
                        <a href="index.html" class="text-decoration-none">
                            <img src="img/logo_white.png" class="img-fluid mb-4"
                        ...
                        <ul class="list list-icons list-icons-lg">
                            <li class="d-flex px-0 mb-1">
                                ...
                                <a href="tel:8001234567"
                                    class="text-color-light font-weight-semibold text-3-4 ms-2">OSMAN AL AMIN NO: +254 786 979774</a>
                            </li>
                            <li class="d-flex px-0 my-3">
                                ...
                                <a href="mailto:info@omny.com"
                                    class="text-color-light font-weight-semibold text-3-4 ms-2">info@ethioomny.com</a>
                            </li>
                            <li class="d-flex font-weight-semibold text-color-light px-0 mb-1">
                                ...
                                Ethio Omny Trading Plc,<br> NEW WOREDA 03, <br> NO WOREDA-144, <br> BOLE ADDIS ABABA, Ethiopia
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-lg-2">
                        ...
                        <ul class="list list-icons list-icons-sm">
                            <li>
                                ...
                                <a href="<?php echo BASE_URL.'contact.php'; ?>" class="link-hover-style-1 ms-1"> Contact Us</a>
                            </li>
                            <li>
                                <i class="fas fa-angle-right text-color-default"></i>
                                <a href="<?php echo BASE_URL.'services.php'; ?>" class="link-hover-style-1 ms-1"> Our Services</a>
                            </li>
<!--                             <li>
                                <i class="fas fa-angle-right text-color-default"></i>
            ...
            <div class="footer-copyright container bg-transparent">
                <div class="row pb-5">
                    <div class="col-lg-12 text-center m-0">
                        ...
                        <p class="text-3-4">Ethino Omny Trading Plc. © 2021. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </footer>
